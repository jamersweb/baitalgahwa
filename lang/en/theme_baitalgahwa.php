...
$string['authpanel_signup_hero_title'] = 'Start your learning journey today';
$string['authpanel_signup_hero_sub'] = 'Join thousands of professionals advancing their careers with Bait Al Gahwa\'s premium training programs.';
$string['authpanel_google_signup'] = 'Create account with Google';
...
$string['enrol_intro_heading'] = 'Introduction';
$string['course_enrol_cta'] = 'View course enrolment page';

$string['enrol_application_eyebrow'] = 'Your details';
$string['enrol_application_title'] = 'Enrolment request';
$string['enrol_application_subtitle'] = 'Tell us how to reach you for this programme.';
$string['enrol_application_required'] = 'Required';
$string['enrol_application_demo_hint'] = 'This form is a design preview — sending will be connected to the server later. If your course has official Moodle enrolment enabled, use that section below as well.';
$string['enrol_application_preview_ok'] = 'Details look valid (preview only — not saved yet).';
$string['enrol_application_err_required'] = 'Please fill in this field.';
$string['enrol_application_err_email'] = 'Please enter a valid email address.';
$string['enrol_application_fullname'] = 'Full name';
$string['enrol_application_email'] = 'Email';
$string['enrol_application_phone'] = 'Phone number';
$string['enrol_application_city'] = 'City';
$string['enrol_application_country'] = 'Country';
$string['enrol_application_notes'] = 'Notes or questions';
$string['enrol_application_optional'] = 'Optional';
$string['enrol_application_submit'] = 'Submit request';
...
$string['dashboard_filter_category'] = 'Select category';
$string['dashboard_filter_all_categories'] = 'All categories';
$string['dashboard_filter_all_courses'] = 'All courses';
$string['dashboard_filter_all_events'] = 'All events';
$string['dashboard_filter_sessions'] = 'Sessions';
$string['dashboard_filter_deadlines'] = 'Deadlines';
$string['dashboard_new_event'] = 'New event';
$string['dashboard_import_export'] = 'Import or export calendar';
$string['dashboard_fullcal'] = 'Full calendar';
$string['dashboard_quiz_title'] = 'Quiz attempts';
$string['dashboard_filter_all_quizzes'] = 'All quizzes';
$string['dashboard_filter_concept_check'] = 'Concept check';
$string['dashboard_filter_practice_quiz'] = 'Practice quiz';
$string['dashboard_filter_final_assessment'] = 'Final assessment';
$string['dashboard_quiz_attempted'] = 'Attempted quizzes';
$string['dashboard_quiz_not_attempted'] = 'Available range';
...
$string['dashboard_featured_tag'] = 'Featured programme';
$string['dashboard_overview_tab'] = 'Overview';
$string['dashboard_intro_heading'] = 'Introduction';
$string['dashboard_intro_fallback'] = 'Continue building your skills through a curated learning journey inspired by Bait Al Gahwa.';
$string['dashboard_announcement_title'] = 'Announcement';
$string['dashboard_announcement_body'] = 'Open the featured programme to continue learning, review updates, and access the latest activities in one place.';
$string['dashboard_activity_heading'] = 'Activities';
$string['dashboard_activity_intro'] = 'Continue with the programmes currently available in your learning space.';
$string['dashboard_members_link'] = 'View all members';
...
$string['dashboard_news_name'] = 'Name';
$string['dashboard_news_email'] = 'Email';
$string['dashboard_news_topic'] = 'Topic';
$string['dashboard_news_course'] = 'Course';
$string['dashboard_news_message'] = 'Message';
$string['dashboard_news_name_placeholder'] = 'Your name';
$string['dashboard_news_email_placeholder'] = 'name@example.com';
$string['dashboard_news_course_placeholder'] = 'Course name';
$string['dashboard_news_message_placeholder'] = 'Write your message';
$string['dashboard_news_option_questions'] = 'Questions';
$string['dashboard_news_option_feedback'] = 'Feedback';
$string['dashboard_news_option_support'] = 'Support';
